...
function Login() {
  ...
  if (imageError) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 max-w-[840px] mx-auto p-4">
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <AnimatePresence>
        ...
        {localUserStream && loginResult === "FAILED" && (
          <motion.div
            ...
            className="text-center"
          >
            <h2 className="text-3xl font-extrabold tracking-tight text-rose-700 sm:text-4xl">
      ...
      <div className="w-full max-w-[720px]">
        <div className="relative flex flex-col items-center p-4 bg-white rounded-2xl shadow-lg">
          <video
            muted
            autoPlay
            ref={videoRef}
            ...
            {modelsLoaded ? (
              <>
                ...
                <motion.button
                  ...
                  type="button"
                  className="flex justify-center items-center w-full py-3 px-6 text-lg font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-lg shadow-md transition-all"
                >
                  Scan my face
                </motion.button>
              </>
              ...
              <>
                ...
                <button
                  disabled
                  type="button"
                  className="cursor-not-allowed flex justify-center items-center w-full py-3 px-6 text-lg font-medium text-gray-500 bg-gray-200 rounded-lg shadow-md"
                >
                  <svg
                    aria-hidden="true"
                    role="status"
                    className="inline mr-2 w-4 h-4 text-gray-500 animate-spin"
                    viewBox="0 0 100 101"
                    fill="none"
